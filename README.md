# 🧠 42 Master — My Common Core Journey
...
|:----:|:---------|:-------------|:----------|:--------:|
| 00 | [LibFT] (https://github.com/AlexGRDev/42_Master/tree/main/Rank%200/LibFT) | Custom implementation of libc functions. | C | In Progress |
